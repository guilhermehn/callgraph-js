...
var graph = {
  ...
  canvasArrow: function (fromx, fromy, tox, toy) {
    ...
    if (tox < fromx) {
      if (fromy === toy) {
        code += ' C ' + (fromx + 20) + ' ' + fromy + ' , ' + (fromx + 20) + ' ' + (toy - loopSize) + ', ' + fromx + ' ' + (toy - loopSize);
        code += ' L ' + tox + ' ' + (toy - loopSize);
        code += ' C ' + (tox - 20) + ' ' + (toy - loopSize) + ', ' + (tox - 20) + ' ' + toy + ', ' + tox + ' ' + toy;
      }
      else {
        code += ' C ' + Math.max(avgx, fromx + 150) + ' ' + fromy + ', ' + Math.min(avgx, tox - 150) + ' ' + toy + ', ' + tox + ' ' + toy;
      }
    }
    else {
      code += ' C ' + Math.max(avgx, fromx + yDiff) + ' ' + fromy + ', ' + Math.min(avgx, tox - yDiff) + ' ' + toy + ', ' + tox + ' ' + toy;
    }
